        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">Здравствуйте, ${user.username}, вот список ваших друзей</h3>
                </div>
                    ...
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th class="border-0 text-uppercase small font-weight-bold">Chat</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${friends}" var="profile">
                                <tr>
